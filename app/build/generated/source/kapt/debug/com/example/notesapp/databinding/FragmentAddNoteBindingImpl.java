...
public class FragmentAddNoteBindingImpl extends FragmentAddNoteBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.addNoteHeading, 1);
        sViewsWithIds.put(R.id.addNoteTitle, 2);
        sViewsWithIds.put(R.id.addNoteDesc, 3);
    }
    // views
    @NonNull
